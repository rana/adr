...
pub fn validate_houses(reps: &[Person]) -> Result<()> {
...
pub fn extract_houses(html: &str) -> Result<Vec<Person>> {
...
pub fn extract_house_addresses(rep: &Person, lnes: &[String]) -> Option<Vec<Address>> {
...
pub fn validate_house_addresses(rep: &Person, adrs: &[Address]) -> Result<()> {
